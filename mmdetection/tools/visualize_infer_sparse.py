...
# 加载模型
# mask_model = load_model('work_dirs/sparse_rcnn_voc/20250527_082051/vis_data/config.py', 'work_dirs/sparse_rcnn_voc/epoch_12.pth')
mask_model = load_model('work_dirs/sparse_final/sparse_final.py', 'work_dirs/sparse_final/epoch_24.pth')
...
for img_path in voc_test_images:
    # visualize_prediction_with_masks(mask_model, img_path, f'../outputs/sparseinst/{os.path.basename(img_path)}')
    visualize_prediction_with_masks(mask_model, img_path, f'../outputs/sparseinst_new/{os.path.basename(img_path)}')
